...
<section class="courses bg-white">
    <div class="services" id="products">
        <h1 class="d-flex justify-content-center fs-1 fw-bold py-4">Products</h1>
        <div class="row row-cols-1 row-cols-md-3 g-4">
            <div class="col">
                <div class="card h-100 d-flex align-items-stretch">
                    <img src="./images/product1.png" class="card-img-top" alt="...">
                    <div class="card-body">
                    <a href="https://www.google.com/search?q=furniture+images+for+website+design&rlz=1C1JJTC_enIN1017IN1017&oq=&gs_lcrp=EgZjaHJvbWUqCQgBECMYJxjqAjIJCAAQIxgnGOoCMgkIARAjGCcY6gIyCQgCECMYJxjqAjIJCAMQIxgnGOoCMgkIBBAjGCcY6gIyCQgFECMYJxjqAjIJCAYQIxgnGOoCMgkIBxAjGCcY6gLSAQkyOTkwajBqMTWoAgiwAgE&sourceid=chrome&ie=UTF-8" class="btn btn-success fw-bold m-2 d-flex justify-content-center" id="bookbtn">View for free</a>
                     </div>
                </div>
            </div>
            <div class="col">
...
<section class="courses bg-white" id="products">
    <div class="container">
        <div class="row row-cols-1 row-cols-md-3 g-4">
            <div class="col">
                <div class="card h-100 d-flex align-items-stretch">
...
<section class="text-red-900 text-xl testimonial" id="testimonial">
    <h1 class="d-flex justify-content-center fs-1 fw-bold py-4">What does Customers say about us?</h1>
    <div class="container px-5 py-24 mx-auto">
        <div class="flex flex-wrap -m-4">
            <div class="lg:w-1/3 lg:mb-0 mb-6 p-4">
                <div class="h-full text-center">
                    <img alt="testimonial" class="w-20 h-20 mb-8 object-cover object-center rounded-full inline-block border-2 border-gray-200 bg-gray-100" src="./images/person1.png">
            ...
            <div class="lg:w-1/3 lg:mb-0 mb-6 p-4">
                <div class="h-full text-center">
                    <img alt="testimonial" class="w-20 h-20 mb-8 object-cover object-center rounded-full inline-block border-2 border-gray-200 bg-gray-100" src="./images/person2.png">
                    <p class="leading-relaxed">Edison bulb retro cloud bread echo park, helvetica stumptown taiyaki taxidermy 90's cronut +1 kinfolk. Single-origin coffee ennui shaman taiyaki vape DIY tote bag drinking vinegar cronut adaptogen squid fanny pack vaporware.</p>
                    <span class="inline-block h-1 w-10 rounded bg-indigo-500 mt-6 mb-4"></span>
            ...
            <div class="lg:w-1/3 lg:mb-0 p-4">
                <div class="h-full text-center">
                    <img alt="testimonial" class="w-20 h-20 mb-8 object-cover object-center rounded-full inline-block border-2 border-gray-200 bg-gray-100" src="./images/person3.png">
                    <p class="leading-relaxed">Edison bulb retro cloud bread echo park, helvetica stumptown taiyaki taxidermy 90's cronut +1 kinfolk. Single-origin coffee ennui shaman taiyaki vape DIY tote bag drinking vinegar cronut adaptogen squid fanny pack vaporware.</p>
                    <span class="inline-block h-1 w-10 rounded bg-indigo-500 mt-6 mb-4"></span>
...
<section class="footer">
  ...
  <div class="box-container">
      ...
      <div class="box">
          <h3>Easy Buy Nest</h3>
          <p>Thank you for visiting our page. Connect with us over socials. <br/> <br/> Keep Rising 🚀. Happy shopping</p>
      </div>
      ...
      <div class="box">
          ...
          <a href="#products"><i class="fas fa-chevron-circle-right"></i> products</a>
      ...
      <div class="box">
          ...
          <p> <i class="fas fa-envelope"></i>easybuynest@gmail.com</p>
          ...
          <div class="share">
              ...
              <a href="mailto:easybuynest@gmail.com" class="fas fa-envelope" aria-label="Mail" target="_blank"></a>
              <a href="https://t.me/imps1001" class="fab fa-telegram-plane" aria-label="Telegram" target="_blank"></a>
              <a href="https://www.youtube.com/@easybuynest" target="_blank" class="fa-brands fa-youtube" aria-label="Youtube"></a>
          </div>
      </div>
  </div>

  <h1 class="credit">Designed with <i class="fa fa-heart pulse"></i> by <a href="https://www.linkedin.com/in/imps1001"> Manju</a></h1>
